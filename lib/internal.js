...
var bem = function (value, type) { return (value ? value + "__" + type : undefined); };
...
var TransparentButton = css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    :focus {\n        border: none;\n        outline: none;\n        box-shadow: none;\n    }\n"], ["\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    :focus {\n        border: none;\n        outline: none;\n        box-shadow: none;\n    }\n"])));
...
var utilityMenu__icon___active = {
    color: primaryPressed
};
var utilityMenu__icon___hover = {
...
var index$1 = /*#__PURE__*/Object.freeze({
    ...
    centerHorizontallyVertically: centerHorizontallyVertically,
    ...
    button: button,
    ellipsis: ellipsis,
    fillFlexContainer: fillFlexContainer,
    geFont: geFont,
    rgb: rgb,
    sensibleBoxModel: sensibleBoxModel,
    tabBar: tabBar,
    utilityMenu: utilityMenu,
    utilityMenu__target: utilityMenu__target,
    utilityMenu__icon: utilityMenu__icon,
    utilityMenu__icon___active: utilityMenu__icon___active,
    utilityMenu__icon___hover: utilityMenu__icon___hover,
    px: px,
    pct: pct,
...
var index$3 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    StatelessPreactDucklet: StatelessPreactDucklet
});
...
var ColorTile = /** @class */ (function () {
    function ColorTile(initialAttrs) {
        this.mountPoint = new MountPoint();
        this.onClick = null;
        this.initialAttrs = __assign(__assign({}, defaultAttrs), initialAttrs);
    }
    ColorTile.prototype.mount = function (element, attrs) {
        this.mountPoint.mount(element, 'div');
        this.applyAttrs(__assign(__assign({}, this.initialAttrs), attrs));
        return this;
    };
    ColorTile.prototype.applyAttrs = function (attrs) {
        var useAttrs = __assign(__assign({}, defaultAttrs), attrs);
        this.applyStyles(useAttrs);
        this.applyTestid(useAttrs);
        this.applyOnClick(useAttrs);
    };
    ColorTile.prototype.applyStyles = function (attrs) {
        this.mountPoint.withFirstChild(function (firstChild) {
            firstChild.style.backgroundColor = attrs.backgroundColor;
            firstChild.style.height = attrs.height;
            firstChild.style.width = attrs.width;
        });
    };
    ColorTile.prototype.applyTestid = function (attrs) {
        this.mountPoint.withFirstChild(function (firstChild) {
            if (attrs.testid.length) {
                firstChild.setAttribute('data-testid', attrs.testid);
            }
        });
    };
    ColorTile.prototype.applyOnClick = function (attrs) {
        var _this = this;
        this.mountPoint.withFirstChild(function (firstChild) {
            if (_this.onClick)
                firstChild.removeEventListener('click', _this.onClick);
            _this.onClick = attrs.onClick;
            firstChild.addEventListener('click', _this.onClick);
        });
    };
    ColorTile.prototype.unmount = function () {
        this.clearOnClick();
        return this.mountPoint.unmount();
    };
    ColorTile.prototype.clearOnClick = function () {
        var _this = this;
        this.mountPoint.withFirstChild(function (element) {
            if (_this.onClick)
                element.removeEventListener('click', _this.onClick);
        });
        this.onClick = null;
    };
    ColorTile.prototype.update = function (callback) {
        var attrs = callback();
...
function of(initialAttrs) {
    if (initialAttrs === void 0) { initialAttrs = {}; }
    return new ColorTile(initialAttrs);
}

var colorTile = /*#__PURE__*/Object.freeze({
    __proto__: null,
    of: of
});
...
function of$1(ducklet, attrs) {
    return new PreexistingAttrDecorator(ducklet, attrs);
}

var preexistingAttrDecorator = /*#__PURE__*/Object.freeze({
    __proto__: null,
    of: of$1
});
...
var ImmutableDuckletList = /** @class */ (function () {
    ...
    ImmutableDuckletList.prototype.setClassNames = function (attrs) {
        var _this = this;
        this.mountPoint.withFirstChild(function (firstChild) {
            var className = __assign(__assign({}, defaultAttrs$1), attrs).className;
            firstChild.className = cx(defaultClassName, _this.immutableClassName, className);
        });
    };
    ImmutableDuckletList.prototype.setTestId = function (attrs) {
        this.mountPoint.withFirstChild(function (firstChild) {
            var testid = __assign(__assign({}, defaultAttrs$1), attrs).testid;
            if (testid.length)
...
function of$2(children, immutableClassName, attrs) {
    if (immutableClassName === void 0) { immutableClassName = ''; }
    if (attrs === void 0) { attrs = {}; }
    return of$1(new ImmutableDuckletList(children, immutableClassName), attrs);
}
function ofEmpty() {
    return of$2([]);
}
...
var onClickWrapper = function (props, event) {
    var customEvent = {
        props: props,
        nativeEvent: event
    };
...
var onClick = function (props) {
    return optionalProp('onClick', onClickWrapper.bind(null, props));
};
var DropdownItem = function (props) { return (h("div", __assign({ className: DropdownItemStyle, style: checkForSeparators(props) }, __assign({}, onClick(props))),
    h("a", __assign({ className: 'ns-dropdown-item' }, __assign({}, testid(props))),
...
var DropdownStyle = css(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n    border: ", ";\n    box-shadow: ", ";\n    width: max-content;\n    font-family: 'GE Inspira Sans';\n"], ["\n    border: ", ";\n    box-shadow: ", ";\n    width: max-content;\n    font-family: 'GE Inspira Sans';\n"])), dropdown_2.panel.border.light, dropdown_2.panel.shadow.light);
...
var Icon = /** @class */ (function () {
    function Icon(initialAttrs) {
        if (initialAttrs === void 0) { initialAttrs = {}; }
        this.mountPoint = new MountPoint();
        this.onClick = null;
        this.initialAttrs = __assign(__assign({}, defaultAttrs$2), initialAttrs);
    }
    Icon.prototype.mount = function (element, attrs) {
        this.mountPoint.mount(element, 'div');
        this.applyAttrs(__assign(__assign({}, this.initialAttrs), attrs));
        return this;
    };
    Icon.prototype.applyAttrs = function (attrs) {
        var useAttrs = __assign(__assign({}, defaultAttrs$2), attrs);
        this.applyStyles(useAttrs);
        this.applyTestid(useAttrs);
        this.applyOnClick(useAttrs);
        this.addIcon(useAttrs);
    };
    Icon.prototype.applyStyles = function (attrs) {
        this.mountPoint.withFirstChild(function (firstChild) {
            firstChild.className = defaultClassName$1;
            firstChild.style.height = attrs.height;
            firstChild.style.width = attrs.width;
        });
    };
    Icon.prototype.applyTestid = function (attrs) {
        this.mountPoint.withFirstChild(function (firstChild) {
            if (attrs.testid.length) {
                firstChild.setAttribute('data-testid', attrs.testid);
            }
    ...
    Icon.prototype.applyOnClick = function (attrs) {
        var _this = this;
        this.mountPoint.withFirstChild(function (firstChild) {
            if (_this.onClick)
                firstChild.removeEventListener('click', _this.onClick);
    ...
    Icon.prototype.addIcon = function (attrs) {
        this.mountPoint.withFirstChild(function (firstChild) {
            var i = firstChild.firstChild;
            if (!i) {
                i = document.createElement('i');
                firstChild.appendChild(i);
            }
            i.className = attrs.icon;
            i.style.fontSize = attrs.size;
        });
    };
    Icon.prototype.unmount = function () {
        this.clearOnClick();
        return this.mountPoint.unmount();
    };
    Icon.prototype.clearOnClick = function () {
        var _this = this;
        this.mountPoint.withFirstChild(function (element) {
            if (_this.onClick)
                element.removeEventListener('click', _this.onClick);
    ...
    Icon.prototype.update = function (callback) {
        var attrs = callback();
        this.applyAttrs(attrs);
        return this;
    };
...
var className = css(__assign(__assign(__assign({}, button), ellipsis), { maxWidth: 150, minWidth: 50 }));
...
var onClick$1 = function (props) { return optionalProp('onClick', props.onClick); };
var TextButtonP = function (props) { return (h("button", __assign({}, __assign(__assign({ className: className }, testid$1(props)), onClick$1(props))), caption(props))); };
...
var tooltip = function (props) { return requiredProp('tooltip', props.tooltip); };
var value = function (props) { return optionalProp('value', props.value); };
...
var disabled = function (props) { return optionalProp('disabled', props.disabled); };
var className$1 = function (props) { return cx(buttonStyle, props.className); };
var ToggleButton = function (props) {
    var elementId = guid();
    return (h("button", __assign({ className: className$1(props) }, __assign(__assign(__assign(__assign(__assign({}, testid$2(props)), tooltip(props)), value(props)), disabled(props)), onClick$2(props))),
        h("input", { id: elementId, type: "checkbox", disabled: props.disabled, checked: props.value, className: switchInput, "data-testid": bem(props.testid, 'value') }),
        h("label", { for: elementId, className: switchLabel, onClick: stopPropagation }, props.tooltip)));
};
...
var index$5 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    ColorTile: colorTile,
    ImmutableDuckletList: immutableDuckletList,
    PreexistingAttrDecorator: preexistingAttrDecorator,
    DropdownItem: DropdownItem,
    Dropdown: Dropdown,
    Icon: Icon,
    PopperWrapper: PopperWrapper,
    TextButtonP: TextButtonP,
...
var tooltip$1 = 'default tooltip';
var subApps = [
    {
        label: 'Asset Instances',
        labelKey: 'ASSET_INSTANCES',
...
var healthApps = [
    ...
    {
        label: 'Asset Health Manager',
        labelKey: 'ASSET_HEALTH_MANAGER',
        folderKey: 'HEALTH',
        href: 'http://www.google.com',
        target: 'tab',
        tooltip: 'Asset Health Manager'
    },
    {
        label: 'Asset Criticality Analysis',
        labelKey: 'ASSET_CRITICALITY_ANALYSIS',
        folderKey: 'HEALTH',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Asset Criticality Analysis'
    },
    {
        label: 'Assets',
        labelKey: 'ASSETS',
...
var strategyApps = [
    {
        ...
        labelKey: 'ASSET_STRATEGY',
        folderKey: 'HEALTH',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Asset Strategy'
    },
    {
        ...
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Action Management'
    },
    {
        label: 'Asset Strategy Management',
        labelKey: 'ACTION_MAN',
        folderKey: 'HEALTH',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Asset Strategy Management'
    },
    {
        label: 'Failure Modes and Effects Analysis',
        labelKey: 'ACTION_MAN',
        folderKey: 'HEALTH',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Failure Modes and Effects Analysis'
    },
];
var integrityApps = [
    {
    ...
    {
        label: 'Hazards Analysis',
        labelKey: 'COMP',
        folderKey: 'HEALTH',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Hazards Analysis'
    },
    {
    ...
    {
        label: 'SIS Management',
        labelKey: 'SIS',
        folderKey: 'HEALTH',
        href: 'http://news.google.com',
        target: 'tab',
        tooltip: 'SIS Management'
    },
    {
        label: 'Graphs',
        labelKey: 'GRAPHS',
...
var adminApps = [
    ...
    },
    {
        ...
        labelKey: 'CONFIGURAITON_MANAGER',
        folderKey: 'ADMIN',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Configuration Manager'
    },
    {
        label: 'Operations Manager',
        labelKey: 'OPERATIONS_MANAGER',
        folderKey: 'ADMIN',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Operations Manager'
    },
];
var appsFolderApps = [
    {
        label: 'Policy Designer',
        labelKey: 'POLICY_DESIGNER',
        folderKey: 'HEALTH',
        href: 'http://www.ge.com',
        target: 'tab',
        tooltip: 'Policy Designer'
    },
    {
        label: 'RBI',
        labelKey: 'RBI',
...
var reliabilityApps = [
    ...
    },
    {
        ...
        labelKey: 'CASE_TEMPLATES',
        folderKey: 'RELIABILITY',
        href: 'http://news.google.com',
        target: 'tab',
        tooltip: 'Case Templates'
    },
    {
        label: 'Generation Availability Analysis Wind',
        labelKey: 'GAA',
        folderKey: 'RELIABILITY',
        href: 'http://news.google.com',
        target: 'tab',
        tooltip: 'Generation Availability Analysis Wind'
    },
    {
        label: 'Production Loss Analysis',
        labelKey: 'PLA',
        folderKey: 'RELIABILITY',
        href: 'http://news.google.com',
        target: 'tab',
...
var applicationMenuTestData = /*#__PURE__*/Object.freeze({
    __proto__: null,
    healthApps: healthApps,
    strategyApps: strategyApps,
    integrityApps: integrityApps,
    adminApps: adminApps,
    appsFolderApps: appsFolderApps,
    toolsFolderApps: toolsFolderApps,
    reliabilityApps: reliabilityApps
});
...
var className$2 = function (props) {
...
var Application = function (props) { return (h("li", { className: className$2(props) },
    h("a", { title: props.tooltip, "data-testid": applicationTestId(props), href: props.href, target: props.target },
        h("span", null,
            props.label,
            h("span", null, subscript(props)))),
    subApps$1(props))); };

var FolderComponentStyle = css(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n    border-top: 1px solid transparent;\n"], ["\n    border-top: 1px solid transparent;\n"])));
var FolderButtonStyle = css(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n    font-size: 15px;\n    font-family: 'GE Inspira Sans';\n    color: ", ";\n    background-color: ", ";\n    height: 30px;\n    margin: 0;\n    padding: 0;\n    cursor: pointer;\n    line-height: 30px;\n\n    i {\n        line-height: 30px;\n        vertical-align: middle;\n        padding-left: 10px;\n        padding-right: 10px;\n    }\n"], ["\n    font-size: 15px;\n    font-family: 'GE Inspira Sans';\n    color: ", ";\n    background-color: ", ";\n    height: 30px;\n    margin: 0;\n    padding: 0;\n    cursor: pointer;\n    line-height: 30px;\n\n    i {\n        line-height: 30px;\n        vertical-align: middle;\n        padding-left: 10px;\n        padding-right: 10px;\n    }\n"])), gray18, gray3);
var ulStyle = css(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n    padding: 0;\n    margin: 0;\n"], ["\n    padding: 0;\n    margin: 0;\n"])));
...
var Folder = function (props) { return (h("div", { className: FolderComponentStyle },
    ...
    h("ul", { style: showApps(props), className: ulStyle, "data-testid": folderOpenTestId(props) }, apps(props)))); };
...
function className$3() {
    return cx(TransparentButton, defaultClassName$2);
}
...
var icon$1 = function (props) { return requiredProp('className', props.icon, 'icon'); };
var onClick$3 = function (props) {
    return requiredProp('onClick', onClickWrapper$2.bind(null, props));
};
var HelpOnPrem = function (props) {
    return (h("div", null,
        h("button", __assign({ className: className$3() }, __assign(__assign(__assign({}, onClick$3(props)), testid$3(props)), tooltip$2(props))),
            h("i", __assign({}, __assign({}, icon$1(props)))))));
};
...
var HelpPEMobile = function (props) {
    return (h("div", null,
        h("button", __assign({ className: className$3() }, __assign(__assign(__assign({}, onClick$4(props)), testid$4(props)), tooltip$3(props))),
...
var HelpPE = function (props) {
    return (h("div", null,
        h("button", __assign({ className: className$3() }, __assign(__assign(__assign({}, onClick$5(props)), testid$5(props)), tooltip$4(props))),
...
var onClickWrapper$5 = function (props) {
...
var onClick$6 = function (props) {
    return requiredProp('onClick', onClickWrapper$5.bind(null, props));
};
var HelpUnifiedMobile = function (props) {
    return (h("div", null,
        h("button", __assign({ className: className$3() }, __assign(__assign(__assign({}, onClick$6(props)), testid$6(props)), tooltip$5(props))),
...
var testid$7 = function (props) { return optionalProp('data-testid', props.testid); };
var onClickWrapper$6 = function (props) {
    props.onClick(format$4(props));
};
var tooltip$6 = function (props) { return requiredProp('title', props.tooltip, 'tooltip'); };
var icon$5 = function (props) { return requiredProp('className', props.icon, 'icon'); };
var onClick$7 = function (props) {
    return requiredProp('onClick', onClickWrapper$6.bind(null, props));
};
var HelpUnified = function (props) {
    return (h("div", null,
        h("button", __assign({ className: className$3() }, __assign(__assign(__assign({}, onClick$7(props)), testid$7(props)), tooltip$6(props))),
            h("i", __assign({}, __assign({}, icon$5(props)))))));
};

exports.HelpOnPrem = HelpOnPrem;
exports.HelpPE = HelpPE;
exports.HelpPEMobile = HelpPEMobile;
exports.HelpUnified = HelpUnified;
exports.HelpUnifiedMobile = HelpUnifiedMobile;
exports.appMenuInternals = internal;
exports.applicationMenuTestData = applicationMenuTestData;
exports.common = index;
exports.designSystem = index$1;
exports.guiduck = index$2;
exports.guiduckPreact = index$3;
exports.preactCommon = index$4;
exports.primitives = index$5;
exports.typeDictionary = index$6;
