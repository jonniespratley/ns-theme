...
const createTime = (e, t = "") => {
 ...
 s();
}, getScopeId = (e, t) => "sc-" + ( e.$tagName$), EMPTY_OBJ = {}, isComplexType = e => "object" == (e = typeof e) || "function" === e, isPromise = e => !!e && ("object" == typeof e || "function" == typeof e) && "function" == typeof e.then, h$1 = (e, t, ...o) => {
...
const nsSpinnerCss = "/*!@:host*/.sc-ns-spinner-h{--px-spinner-fill-color:#007acc;--px-spinner-background-color:#b5e5fd;box-sizing:border-box;display:block}/*!@.circle1*/.circle1.sc-ns-spinner{fill:none;stroke:var(--px-spinner-background-color, #d3d3d3);stroke-width:5px}/*!@.circle2*/.circle2.sc-ns-spinner{fill:none;stroke:var(--px-spinner-fill-color, #000);stroke-width:5px;stroke-dasharray:283;stroke-dashoffset:566;animation:rotate 1.5s infinite cubic-bezier(0.78, 0.13, 0.16, 0.87)}@keyframes rotate{to{stroke-dashoffset:0}}/*!@.spinner-container*/.spinner-container.sc-ns-spinner{font-size:10px;position:relative;text-indent:-9999em;border-top:5px solid var(--px-spinner-background-color, #d3d3d3);border-right:5px solid var(--px-spinner-background-color, #d3d3d3);border-bottom:5px solid var(--px-spinner-background-color, #d3d3d3);border-left:5px solid var(--px-spinner-fill-color, #000);transform:translateZ(0);animation:load8 1.1s infinite cubic-bezier(0.78, 0.13, 0.16, 0.87)}/*!@.spinner-container,\n.spinner-container:after*/.spinner-container.sc-ns-spinner,.spinner-container.sc-ns-spinner:after{border-radius:50%;width:10em;height:10em}@keyframes load8{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}";
...
class NsTheme {
  ...
  drawerHeaderActionHandler(event) {
...
const nsThemeHeaderCss = "/*!@:host*/.sc-ns-theme-header-h{--theme-navbar-color:#b6c3cb;--theme-navbar-brand-color:#b6c3cb;--theme-navbar-background-color:white;--theme-navbar-link-color:#b6c3cb;--theme-navbar-link-color--hover:green;--theme-navbar-dropdown-background-color:white;--theme-navbar-dropdown-border:none;--theme-navbar-link-background-color--hover:rgba(20, 20, 20, 0.2);box-sizing:border-box;min-block-size:fit-content;display:block;font-family:\"GE Inspira Sans\", sans-serif}/*!@:host > **/.sc-ns-theme-header-h>*.sc-ns-theme-header{box-sizing:border-box}/*!@.theme__header*/.theme__header.sc-ns-theme-header{height:50px;background-color:var(--apm-theme-navbar-background-color, #ebeff2);border-bottom:var(--apm-theme-navbar-border, 1px solid #c4cfd6);box-sizing:border-box;width:100%;display:inline-grid;grid-auto-flow:column;grid-template-columns:50px 0fr minmax(0px, 1fr);justify-content:center;align-items:center;user-select:none}/*!@.theme__header button*/.theme__header.sc-ns-theme-header button.sc-ns-theme-header{outline:none}/*!@.theme__header button:hover*/.theme__header.sc-ns-theme-header button.sc-ns-theme-header:hover{background-color:var(--px-app-nav-item-background-color--hover, rgba(0, 0, 0, 0.1))}/*!@.theme__header button:active*/.theme__header.sc-ns-theme-header button.sc-ns-theme-header:active{color:var(--px-app-nav-item-text-color--pressed, #a9a9a9);background-color:var(--px-app-nav-item-background-color--pressed, rgba(0, 0, 0, 0.1))}/*!@.theme__header svg*/.theme__header.sc-ns-theme-header svg.sc-ns-theme-header{stroke:var(--px-app-nav-item-text-color, rgba(0, 0, 0, 0.5));fill:none}/*!@.theme__toggler*/.theme__toggler.sc-ns-theme-header{padding:0.25rem 0.75rem;font-size:1.25rem;line-height:1;background-color:transparent;border:1px solid transparent;border:none;color:var(--px-app-nav-item-text-color, white);align-self:stretch}/*!@.theme__toggler:hover, .theme__toggler:focus*/.theme__toggler.sc-ns-theme-header:hover,.theme__toggler.sc-ns-theme-header:focus{text-decoration:none}/*!@.theme__toggler:not(:disabled):not(.disabled)*/.theme__toggler.sc-ns-theme-header:not(:disabled):not(.disabled){cursor:pointer}/*!@.theme__toggler-icon*/.theme__toggler-icon.sc-ns-theme-header{color:var(--px-app-nav-item-text-color, rgba(0, 0, 0, 0.5));display:inline-block;width:22px;height:22px;vertical-align:middle;content:\"\";background:no-repeat center center;background-size:100% 100%;display:flex;align-items:center;justify-content:center}/*!@.square*/.square.sc-ns-theme-header{border:2px solid var(--px-app-nav-item-text-color, #121f26);width:22px;height:22px;display:flex;align-items:center;justify-content:center;font-size:0.8rem}/*!@.theme__nav*/.theme__nav.sc-ns-theme-header{font-family:\"GE Inspira Sans\", sans-serif}/*!@.theme__nav-item*/.theme__nav-item.sc-ns-theme-header{display:flex;position:relative;align-items:stretch;align-self:stretch;user-select:none}/*!@.theme__nav-item--selected*/.theme__nav-item--selected.sc-ns-theme-header{color:var(--px-app-nav-item-text-color--selected, #a9a9a9);background-color:var(--px-app-nav-item-background-color--selected, #fff)}/*!@.theme__nav-item--selected:before*/.theme__nav-item--selected.sc-ns-theme-header:before{content:\"\";position:absolute;top:0;left:0;right:0;display:block;width:100%;height:var(--px-app-nav-item-stripe-size--selected, 0.13333rem);background-color:var(--px-app-nav-item-stripe-color--selected, #00f)}/*!@.theme__nav-link*/.theme__nav-link.sc-ns-theme-header{user-select:none;outline:none;display:flex;text-decoration:none;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;background:transparent;border:none;font-size:inherit;font-family:\"GE Inspira Sans\", sans-serif;align-items:center;min-width:44px;justify-content:center;text-decoration:none;color:var(--px-app-nav-item-text-color, #2c404c)}/*!@.theme__nav-link:hover*/.theme__nav-link.sc-ns-theme-header:hover{color:var(--px-app-nav-item-text-color--hover, #111);background-color:var(--px-app-nav-item-background-color--hover, #ebeff2)}/*!@.theme__nav-link:active*/.theme__nav-link.sc-ns-theme-header:active{color:var(--px-app-nav-item-text-color--pressed, #222);background-color:var(--px-app-nav-item-background-color--pressed, #d3d3d3)}/*!@.theme__nav-link.active*/.theme__nav-link.active.sc-ns-theme-header{background-color:var(--theme-navbar-link-background-color--active, #1e2a32);border-top:2px solid var(--theme-navbar-link-border-color--active, #17819b)}/*!@.theme__nav*/.theme__nav.sc-ns-theme-header{list-style-type:none;margin:0;padding:0;display:flex;align-items:center;justify-content:center;flex:1;align-self:stretch}/*!@.theme__nav-link*/.theme__nav-link.sc-ns-theme-header{color:var(--px-app-nav-item-text-color, black);align-self:stretch;cursor:pointer}/*!@.theme__nav .close*/.theme__nav.sc-ns-theme-header .close.sc-ns-theme-header{cursor:pointer;position:absolute;top:50%;right:0%;padding:12px 16px;transform:translate(0%, -50%)}/*!@.theme__nav .close:hover*/.theme__nav.sc-ns-theme-header .close.sc-ns-theme-header:hover{background:#bbb}/*!@.theme__nav a*/.theme__nav.sc-ns-theme-header a.sc-ns-theme-header{text-decoration:none !important}/*!@.theme__user*/.theme__user.sc-ns-theme-header{display:flex;align-content:center;align-items:center;margin-right:0.5rem}/*!@.theme__avatar*/.theme__avatar.sc-ns-theme-header{max-height:22px;border-radius:50%;margin:0;margin-right:0.5rem}/*!@.theme__dropdown*/.theme__dropdown.sc-ns-theme-header{position:relative;display:inline-flex}/*!@.theme__dropdown-divider*/.theme__dropdown-divider.sc-ns-theme-header{height:0;margin:0.5rem 0;overflow:hidden;border-top:var(--theme-dropdown-divider, 1px solid black)}/*!@.theme__dropdown-item*/.theme__dropdown-item.sc-ns-theme-header{align-self:stretch;display:block;padding:0.25rem 0.5rem;clear:both;font-weight:400;color:#212529;text-align:inherit;white-space:nowrap;height:30px;background-color:transparent;border:0;color:var(--px-app-nav-subitem-text-color, #212529);background-color:var(--px-app-nav-subitem-background-color, white);align-items:center;justify-content:flex-start;display:flex;box-sizing:border-box}/*!@.theme__dropdown-item:hover*/.theme__dropdown-item.sc-ns-theme-header:hover{background-color:var(--px-app-nav-subitem-background-color--hover, #ebeff2);color:var(--px-app-nav-subitem-text-color--hover, black)}/*!@.theme__dropdown-item:active*/.theme__dropdown-item.sc-ns-theme-header:active{background-color:var(--px-app-nav-subitem-background-color--selected, #09819c);color:var(--px-app-nav-subitem-text-color--selected, white);color:white}/*!@.theme__dropdown-menu*/.theme__dropdown-menu.sc-ns-theme-header{position:absolute;top:100%;left:0;z-index:1000;display:none;float:left;min-width:10rem;padding:0;margin:0;font-size:1rem;color:#212529;text-align:left;list-style:none;background-color:var(--theme-navbar-dropdown-background-color, white);background-clip:padding-box;border:var(--theme-navbar-dropdown-border, 1px solid rgba(0, 0, 0, 0.15));box-shadow:var(--px-app-nav-box-shadow, 0 2px 4px var(--px-shadow-navigation, rgba(0, 0, 0, 0.2)))}/*!@.theme__dropdown:hover .theme__dropdown-menu*/.theme__dropdown.sc-ns-theme-header:hover .theme__dropdown-menu.sc-ns-theme-header{display:block}/*!@.theme__dropdown--right .theme__dropdown-menu*/.theme__dropdown--right.sc-ns-theme-header .theme__dropdown-menu.sc-ns-theme-header{right:0;left:auto}/*!@.px-icon svg*/.px-icon.sc-ns-theme-header svg.sc-ns-theme-header{fill:var(--iron-icon-fill-color, none);stroke:var(--iron-icon-stroke-color, currentColor);display:inline-flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:center;justify-content:center;position:relative;vertical-align:middle;width:var(--iron-icon-width);height:var(--iron-icon-height);color:inherit !important}/*!@.count*/.count.sc-ns-theme-header{position:relative;width:28px;height:28px;align-items:center;cursor:pointer}";
...
const TabManagerButton = ({ onClick, title = 'Tab Manager', tabCount = 0 }) => (hAsync("button", { class: "theme__nav-link theme__tab-btn", role: "button", title: title, onClick: onClick }, hAsync("span", { class: "px-icon square" }, hAsync("span", null, tabCount))));
/*
...
class NsThemeHeader {
  ...
  render() {
    return (hAsync(Host, null, this.headerText && hAsync("a", { class: "theme__navbar-brand", href: "#" }, this.headerText), hAsync("header", { class: `theme__header ${this.isFixed ? 'theme__header--fixed' : ''}` }, this.showMenu && (hAsync("button", { class: "btn theme__toggler collapsed", type: "button", "data-toggle": "collapse", "aria-expanded": "false", "aria-label": "Toggle navigation", onClick: () => {
      ...
      } }, hAsync("span", { class: "theme__toggler-icon" }, hAsync("svg", { viewBox: "0 0 22 22", preserveAspectRatio: "xMidYMid meet", focusable: "false", style: iconStyles }, hAsync("g", null, hAsync("path", { "stroke-miterlimit": "10", d: "M0 4.5h22m-22 6h22m-22 6h22" })))))), hAsync("slot", { name: "menu" }), hAsync("div", null, hAsync("slot", { name: "home" }), this.showHome && hAsync(HomeNavItem, null)), hAsync("slot", { name: "tabs" }), hAsync("div", { class: "theme__user" }, hAsync("slot", { name: "user" })), hAsync("ul", { class: "theme__nav" }, this.tabCount &&
      hAsync("li", { class: "theme__nav-item" }, hAsync(TabManagerButton, { tabCount: this.tabCount, onClick: () => {
          this.tabManagerClickHandler();
        } })), this.user &&
      hAsync("li", { class: "theme__nav-item theme__dropdown theme__dropdown--right theme__user" }, hAsync("button", { class: "theme__nav-link theme__dropdown-toggle", id: "userDropdown", role: "button", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }, this.user.picture && hAsync("img", { class: "theme__avatar", src: this.user.picture, alt: this.user.name }), hAsync("i", { class: "gedi-user" }), hAsync("i", { class: "px-icon" }, hAsync("svg", { viewBox: "0 0 16 16", preserveAspectRatio: "xMidYMid meet", style: Object.assign(Object.assign({}, iconStyles), { width: '16px' }) }, hAsync("g", { id: "px-utl-chevron" }, hAsync("path", { d: "M2.4 6.2l5.5 5.5 5.5-5.5" }))))), hAsync("div", { class: "theme__dropdown-menu ml-auto", "aria-labelledby": "userDropdown" }, this.settings && this.settings.map((item) => (hAsync("a", { class: "theme__dropdown-item", href: item.path, title: item.label }, item.label))), hAsync("a", { class: "theme__dropdown-item", href: "/logout", title: "Logout" }, "Log Out")))))));
  }
